...
NCountry = {
	...
	PS_STRENGTHEN_GOVERNMENT = 75,
	PS_BOOST_MILITARIZATION = 75,
...
NEconomy = {
	...
	DEBASE_MAX_STORED_MONTHS = 120,					-- Debase currency stores up to this many months of charges.
	...
	MINIMUM_INTERESTS = 2.0,						-- _EDEF_MINIMUM_INTERESTS_
...
NMilitary = {
	...
	ARMY_DRILL_YEARLY_DECAY = -0.75,					-- Loss from not Drilling
	ARMY_DRILL_YEARLY_GAIN = 12.5,					-- Gain from Drilling
	...
	DEFAULT_WARGOAL_TICKINGWARSCORE_BONUS = 0.6,		-- Amount of warscore per month since attacker/defender started getting the bonus for completing war goal
	...
	SUPERIORITY_WARGOAL_WARSCORE_THRESHOLD	= 20,	-- Needed battle score for getting ticking war score for war goal superiority
	...
	SUPPLY_DEPOT_MIL_COST = 10,						-- Mil power cost to build a supply depot in an area.
	...
	MARINE_DISEMBARK_SPEED_BONUS = 3.0	,			-- marine disembark speed bonus
...
NGraphics = {
	...
	DIRECTION_POINTER_DRAW_DISTANCE = 1000.0,		-- Direction pointer arrow will not be drawn beyond this distance
